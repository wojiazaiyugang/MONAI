...
def main():
    ...
    out_trained_models_dir = "/home/yujiannan/Projects/MONAI/models/teeth_detection"  # the directory to save trained model weights
    out_tensorboard_events_dir = "/home/yujiannan/Projects/MONAI/logs"  # the directory to save tensorboard training curves
    out_inference_result_dir = "/home/yujiannan/Projects/MONAI/models/teeth_detection/result"  # the directory to save predicted boxes for inference
    #  ------------- Modification ends ---------------
