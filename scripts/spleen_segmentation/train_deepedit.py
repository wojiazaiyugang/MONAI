...
def get_loaders(args, pre_transforms):
    ...
    train_loader = DataLoader(
        train_ds, shuffle=True, num_workers=0
    )
    logging.info(
...
def main():
    ...
    parser.add_argument(
        "-i",
        "--input",
        default="/media/3TB/data/MSD/Task09_Spleen",
    )
    parser.add_argument("-o", "--output", default="/home/yujiannan/Projects/MONAI/scripts/spleen_segmentation/logs/1")
    ...
    parser.add_argument("--cache_dir", type=str, default="/home/yujiannan/Projects/MONAI/data/temp/4")
