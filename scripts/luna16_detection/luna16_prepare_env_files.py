...
def main():
    #  ------------- Modification starts -------------
    raw_data_base_dir = "/media/3TB/data/luna16"  # the directory of the raw images
    resampled_data_base_dir = "/home/yujiannan/Projects/MONAI/data/luna_detection/resampled_data_base_dir"  # the directory of the resampled images
    downloaded_datasplit_dir = "/home/yujiannan/Projects/MONAI/data/luna_detection/LUNA16_datasplit-20220615T233840Z-001/LUNA16_datasplit"  # the directory of downloaded data split files

    out_trained_models_dir = "/home/yujiannan/Projects/MONAI/models/luna16_detection"  # the directory to save trained model weights
    out_tensorboard_events_dir = "/home/yujiannan/Projects/MONAI/logs"  # the directory to save tensorboard training curves
    out_inference_result_dir = "/home/yujiannan/Projects/MONAI/models/luna16_detection/result"  # the directory to save predicted boxes for inference
    #  ------------- Modification ends ---------------
