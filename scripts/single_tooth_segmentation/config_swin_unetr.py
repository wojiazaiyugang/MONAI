...
work_dir = Path(__file__).parent.resolve().joinpath("logs").joinpath("swin_unetr").joinpath("10")
...
CACHE_DIR = Path("/media/3TB/data/xiaoliutech/swin_unetr_single_tooth_segmentation_cache")