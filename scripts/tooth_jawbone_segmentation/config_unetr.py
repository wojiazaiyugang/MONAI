...
WORK_DIR = Path(__file__).resolve().parent.joinpath("logs").joinpath("unetr").joinpath("7")
...
PRETRAINED_MODEL = None #Path("/home/yujiannan/Projects/MONAI/scripts/pretrain_unert/logs/1/best_model.pt")  # 预训练模型
